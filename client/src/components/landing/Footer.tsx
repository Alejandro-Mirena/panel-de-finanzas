  ...
  return (
    <footer className="border-t border-card-border py-10 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-10 sm:mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <span className="font-semibold text-base sm:text-lg">Finanzas</span>
            </div>
        ...
        <div className="border-t border-card-border pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs sm:text-sm text-muted text-center sm:text-left">
            &copy; 2026 Finanzas. Todos los derechos reservados.
          </p>
