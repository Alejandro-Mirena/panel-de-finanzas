const posts = [
  {
    ...
    excerpt:
      "Pequeños habitos que marcan la diferencia al final del mes. Desde automatizar ahorros hasta revisar suscripciones olvidadas.",
    date: "15 Jul 2026",
    category: "Ahorro",
    readTime: "4 min",
  },
  {
    ...
    excerpt:
      "Una guia practica para crear categorias que tengan sentido para tu vida real, sin complicarte con clasificaciones excesivas.",
    date: "10 Jul 2026",
    category: "Guia",
    readTime: "6 min",
  },
  {
    ...
    excerpt:
      "Regla clasica de presupuesto adaptada a la realidad actual. Si funciona para principiantes y para quienes ya tienen experiencia.",
    date: "5 Jul 2026",
    category: "Educacion",
    readTime: "5 min",
  },
  {
    ...
    excerpt:
      "Tener tus numeros en un solo lugar cambia la forma en que tomas decisiones. Te explicamos por que vale la pena.",
    date: "1 Jul 2026",
    category: "Producto",
    readTime: "3 min",
  },
  {
    ...
    excerpt:
      "Esas apps que pagas y no usas estan comiendo tu presupuesto. Como detectarlas y eliminarlas en 10 minutos.",
    date: "25 Jun 2026",
    category: "Ahorro",
    readTime: "4 min",
  },
  {
    ...
    excerpt:
      "No todos los numeros importan igual. Te ensenamos a leer tus graficos para tomar mejores decisiones.",
    date: "20 Jun 2026",
    category: "Guia",
    readTime: "5 min",
  },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-muted text-base sm:text-lg max-w-xl mx-auto">
            Articulos sobre finanzas personales, ahorro y consejos para sacarle
            el maximo provecho a tu dinero.
          </p>
        </div>
