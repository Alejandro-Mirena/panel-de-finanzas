      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-8 text-sm text-muted leading-relaxed">
          <section>
            ...
            <p>
              Recopilamos unicamente la informacion que tu proporcionas
              voluntariamente al usar nuestra plataforma. Esto incluye:
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Datos de registro (nombre, email)</li>
              <li>
                Transacciones que cargas manualmente (montos, fechas,
                categorias)
              </li>
          ...
          <section>
            ...
            <p>
              Tus datos se almacenan en servidores seguros con encriptacion. No
              tenemos acceso a tus cuentas bancarias porque no nos conectamos
              con entidades financieras. Toda la informacion financiera es
              ingresada manualmente por vos.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              terceros. Tu datos son exclusivamente tuyos y no se utilizan con
              fines publicitarios.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              de la plataforma. No usamos cookies de rastreo ni publicitarias.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              privacidad@finanzas.app. Responderemos en un plazo de 48 horas.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              privacidad. Cada cambio sera notificado por email a los usuarios
              registrados.
            </p>
          </section>
        </div>
